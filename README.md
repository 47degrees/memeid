...
```groovy
compile group: 'com.47deg', name: 'memeid', version: '0.5.0'
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-literal" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-doobie" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-circe" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-http4s" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-tapir" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-fuuid" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-cats" % "0.5.0"
```
...
```scala
libraryDependencies += "com.47deg" %% "memeid4s-scalacheck" % "0.5.0"
```
