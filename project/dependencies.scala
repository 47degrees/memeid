...
object dependencies extends AutoPlugin {
  ...
  private val common = Seq("org.specs2" %% "specs2-scalacheck" % "4.10.4" % Test)
  ...
  private val cats = Def.setting {
    Seq(
      ...
      "org.specs2"    %% "specs2-cats"       % "4.10.4"              % Test
    )
  }
  ...
  private val doobie = Def.setting {
    Seq(
      ...
      "org.tpolecat" %% "doobie-specs2" % "0.9.2"        % Test,
      "org.tpolecat" %% "doobie-h2"     % "0.9.2"        % Test,
      "org.specs2"   %% "specs2-cats"   % "4.10.4"       % Test
    )
  }
