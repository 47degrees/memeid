...
object dependencies extends AutoPlugin {
  ...
  private val common = List("org.specs2" %% "specs2-scalacheck" % "4.18.0" % Test)
  ...
  private val http4s = List(
    ...
    "org.http4s" %% "http4s-dsl"  % "0.23.16" % Test
  )

  private val tapir = List(
    "com.softwaremill.sttp.tapir"   %% "tapir-core"         % "1.1.4",
    "com.softwaremill.sttp.tapir"   %% "tapir-openapi-docs" % "1.1.4" % Test,
