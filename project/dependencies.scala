...
object dependencies extends AutoPlugin {
  ...
  private val doobie = Def.setting {
    Seq(
      ...
      "org.tpolecat" %% "doobie-specs2" % "0.12.0"       % Test,
      "org.tpolecat" %% "doobie-h2"     % "0.12.0"       % Test,
      "org.specs2"   %% "specs2-cats"   % "4.10.6"       % Test
    )
  }
  ...
  private val tapir = Def.setting {
    Seq(
      ...
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-docs"       % "0.17.14" % Test,
      "com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.17.14" % Test
    )
  }
