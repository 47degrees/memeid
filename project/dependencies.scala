...
object dependencies extends AutoPlugin {
  ...
  private val common = List("org.specs2" %% "specs2-scalacheck" % "4.13.1" % Test)
  ...
  private val http4s = List(
    ...
    "org.http4s" %% "http4s-dsl"  % "0.23.7" % Test
  )

  private val tapir = List(
    "com.softwaremill.sttp.tapir" %% "tapir-core"               % "0.19.3",
    "com.softwaremill.sttp.tapir" %% "tapir-openapi-docs"       % "0.19.3" % Test,
    "com.softwaremill.sttp.tapir" %% "tapir-openapi-circe-yaml" % "0.19.3" % Test
  )
